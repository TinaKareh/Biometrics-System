 ...
 */
public class Morpho_Fingerprints extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Morpho_Fingerprints
     */
    public Morpho_Fingerprints() {
        initComponents();
        setNewDataPaths();
    ...
    public void setNewDataPaths() {
        ...
        try {
            ...
            serverPngPath = "/var/www/html/biopng/fingerprints/";
    ...
    public void initiateImages() {
     ...
     public Morpho_Fingerprints displayfingerprints() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Morpho_Fingerprints.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Morpho_Fingerprints().setVisible(true);
            }
        });
    }
