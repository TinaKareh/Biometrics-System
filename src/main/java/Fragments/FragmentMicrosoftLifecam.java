 ...
 */
public class FragmentMicrosoftLifecam extends javax.swing.JPanel {
static Example programExample = null;
    ...
    /**
     * Creates new form FragmentMicrosoftLifecam
     */
    public FragmentMicrosoftLifecam() {
        initComponents();
        setNewDataPaths();
        cleanTemporaryDirectories();
    }
    
  public FragmentMicrosoftLifecam(NewBiometricDevices devices,String application_no,String applicantId,String user) {
   ...
   private void setNewDataPaths() {
     ...
     public FragmentMicrosoftLifecam displayPhotograph() throws IOException {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       TestWebcam webcam = new TestWebcam(this,applicantId);
