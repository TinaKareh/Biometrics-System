 ...
 */
public class BiometricsMenu extends javax.swing.JPanel {
    ...
    private void init() {
        leftSideMenu.addItem(new DatalMenu("7", "Home", DatalMenu.MenuType.MENU));
        leftSideMenu.addItem(new DatalMenu("7", "Dashboard", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("5", "Enrollment Details", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("5", "Biometrics", DatalMenu.MenuType.MENU));
        leftSideMenu.addItem(new DatalMenu("8", "Photo", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("9", "Signature", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("10", "Fingerprint", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("5", "Settings", DatalMenu.MenuType.MENU));
