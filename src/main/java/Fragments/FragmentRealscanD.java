 ...
 */
public class FragmentRealscanD extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FragmentRealscanD
     */
    public FragmentRealscanD() throws IOException {
        initComponents();
        setNewDataPaths();
    ...
    public FragmentRealscanD(NewBiometricDevices devices,String application_no,String applicantId,String user) throws IOException {
     ...
     private FragmentRealscanD displayfingerprints() throws IOException {
                   ...
                   File output = new File("C:\\Users\\Futuristic Ltd\\OneDrive\\Documents\\NetBeansProjects\\kaa-biometrics\\IDMSBiometrics\\IDMSBiometrics\\target\\fingerprints\\png\\"+ applicantId.toString().concat("RIGHT_MIDDLE.png"));  
                    ...
                    //Write the image to the destination as a JPG  
                       ImageIO.write(image, "png", output);
                        ...
                        ImageIcon imageIcon11 = new ImageIcon(new ImageIcon("C:\\Users\\Futuristic Ltd\\OneDrive\\Documents\\NetBeansProjects\\kaa-biometrics\\IDMSBiometrics\\IDMSBiometrics\\target\\fingerprints\\png\\"+ applicantId.toString().concat("THUMB_CAPTURE.png")).getImage().getScaledInstance(jLabel36.getWidth(), jLabel36.getHeight(), Image.SCALE_SMOOTH));
...
private  void startThread(){
        ...
        Integer userId = Integer.parseInt(user);
            ...
            uploadAndSave.uploadRealscanfingerprints(serverPngPath, clientPngPath,applicantId, isJuvenile, isAmputee, isPartialAmputee);
            uploadAndSave.updateForm25(applicantId,application_no);
            uploadAndSave.updatePermitBiometrics(userId,applicantId);
       ...
       d.setVisible(true); 
            ...
            //NewBiometricDevices devices = new NewBiometricDevices();
             //devices.setUndecorated(true);
         SwingWorker sw1 = new SwingWorker() {
