...
public class EnrollmentMenu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        leftSideMenu.addItem(new DatalMenu("17", "Enroll", DatalMenu.MenuType.MENU));
        leftSideMenu.addItem(new DatalMenu("3", "New", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("4", "Re-issue", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("2", "Enrollment Status", DatalMenu.MenuType.MENU));
        leftSideMenu.addItem(new DatalMenu("3", "Incomplete Registration", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("4", "Pending Biometric", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("13", "Complete Enrollment", DatalMenu.MenuType.TITLE));
        leftSideMenu.addItem(new DatalMenu("6", "Settings", DatalMenu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        sharpCorner1Layout.setHorizontalGroup(
            ...
            .addComponent(moveHeader, javax.swing.GroupLayout.DEFAULT_SIZE, 237, Short.MAX_VALUE)
        ...
        sharpCorner1Layout.setVerticalGroup(
            ...
            .addGroup(sharpCorner1Layout.createSequentialGroup()
                .addComponent(moveHeader, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                .addComponent(leftSideMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 469, Short.MAX_VALUE))
        );
