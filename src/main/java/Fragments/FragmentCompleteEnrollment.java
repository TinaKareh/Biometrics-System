 ...
 */
public class FragmentCompleteEnrollment extends javax.swing.JPanel {

    private ArrayList<EnrollmentDetails> completeEnrollment;

    /**
     * Creates new form FragmentCompleteEnrollment
     */
    public FragmentCompleteEnrollment() {
        initComponents();
    ...
    private void init() {
        ...
        completeEnrollment = new ArrayList<>();
        completeEnrollment = new CrudBean().getCompleteEnrollment();
        if (completeEnrollment.size() > 0) {
            for (int i = 0; i < completeEnrollment.size(); i++) {
                EnrollmentDetails details = completeEnrollment.get(i);
