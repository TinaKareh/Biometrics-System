 ...
 */
public class FragmentVerificationData extends javax.swing.JPanel {

    private ArrayList<EnrollmentDetails> listingApplicants;
    private VerificationDashboard data;
    /**
     * Creates new form FragmentVerificationData
     */
    public FragmentVerificationData() {
        initComponents();
    ...
    public FragmentVerificationData(VerificationDashboard data) {
        initComponents();
        this.data = data;
           DefaultTableCellRenderer centerRenderer = new DefaultTableCellRenderer();
       centerRenderer.setHorizontalAlignment( JLabel.CENTER );
    ...
    private void tableSwing91MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableSwing91MouseClicked
        ...
        try {
         ...
         System.out.println(jsonObject);
            ...
            data.setForm(new FragmentVerifyData(data,jsonObject));
        }catch (SQLException e) {
            System.err.println();
            e.printStackTrace();
        } catch (ParseException ex) {
            Logger.getLogger(FragmentVerificationData.class.getName()).log(Level.SEVERE, null, ex);
        }
