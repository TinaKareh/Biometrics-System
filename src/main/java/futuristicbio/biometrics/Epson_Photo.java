 ...
 */
public class Epson_Photo extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Epson_Photo
     */
    public Epson_Photo() throws IOException {
        initComponents();
        setNewDataPaths();
    ...
    public void setNewDataPaths() {
        ...
        try {
            ...
            prop.load(input);
             ...
             serverPhotoPngPath = "/var/www/html/biopng/photos/";
    ...
    public Epson_Photo displayPhotograph() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Epson_Photo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Epson_Photo().setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(Epson_Photo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
